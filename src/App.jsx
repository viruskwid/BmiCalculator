  ...
  return (
    <>
      <div className='d-flex justify-content-center align-items-center wrapper' style={{width:'100%',height:'100vh'}}>
        ...
        <h2 style={{fontSize:'40px', marginTop:'100px'}}>BMI Calculator</h2>
        ...
        <div style={{width:'100%',height:'150px'}} className='d-flex justify-content-center align-items-center flex-column bg-info'>
          ...
          <p style={{fontSize:'20px'}} className='fw-bolder'>Body Mass Index is a person’s weight in kilograms divided by the square of height in meters.</p>
        </div>
        <form  onSubmit={handleCalculate}>
          <div className='inp'>
          <Form.Control size="lg" style={{height:'25px',width:'170px'}} name='age' type="text" placeholder="Enter Age" onChange={e=>validUserInput(e)} value={Age || ""}  />
          </div>
          {!validAge&&<div className='mb-3 text-danger fw-bolder'>
            Invalid Age Input
          </div>}
          <div className='mb-3 inp'>
          <Form.Control size="lg" style={{height:'25px',width:'170px'}} name='weight' type="text" placeholder="Weight in Kgs" onChange={e=>validUserInput(e)} value={Weight || ""} />
          </div>
          {!validWeight&&<div className='mb-3 text-danger fw-bolder'>
            Invalid Weight Input
          </div>}
          <div className='mb-3 inp'>
          <Form.Control size="lg" style={{height:'25px',width:'170px'}} name='height' type="text" placeholder="Height in cms" onChange={e=>validUserInput(e)} value={Height|| ""} />
          </div>
